                  ...
                  {isDropdownOpen && (
                    ...
                    >
                      ...
                      <ul className="py-2" aria-labelledby="user-menu-button">
                        ...
                        <li>
                          <Link to="/" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">{Home}Home</Link>
                        </li>
                        <li>
                          <Link to="/register" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">{Register}Add new account</Link>
                        </li>
                        <li>
                          <h5
