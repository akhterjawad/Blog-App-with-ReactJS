              ...
              return (
                <div key={index} className="bg-white mt-10 mb-10 shadow-md rounded-lg p-6 w-[95%] sm:w-[80%]">
                  <div className="flex items-center space-x-4">
                    <img
                      src={user ? user.profileImage : 'defaultImage.png'} // Agar user data mile toh uska image lagaye, warna default image
                      alt="Author Image"
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {user ? user.fullName : 'Anonymous'} - {blog.time.toDate().toLocaleString()} {/* Display the timestamp */}
                      </p>
                    </div>
                  </div>
